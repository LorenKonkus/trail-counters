...
- ThriftyCounter - a minimal Adafruit M0 Adalogger feather based counter that records trail usage data on an SD card. The primary goal was low cost (under $25 plus battery) and low power usage (about 1.5 ma with microwave sensor). In progress.
